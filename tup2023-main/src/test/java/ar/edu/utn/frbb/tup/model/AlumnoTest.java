...
public class AlumnoTest {
    ...
    public static void setUp() {
        ...
        m1 = new Materia("Laboratorio 1", 1, 1);
        m2 = new Materia("Laboratorio 2", 1, 2);
        m3 = new Materia("Laboratorio 3", 2, 1);
        m4 = new Materia("Laboratorio 4", 2, 2);
    ...
    public void testNewAlumno() {
        alumno = new Alumno("Facundo", "Elizalde", 44883011);
        assertEquals("Facundo", alumno.getNombre());
        assertEquals("Elizalde", alumno.getApellido());
        assertEquals(44883011, alumno.getDni());
